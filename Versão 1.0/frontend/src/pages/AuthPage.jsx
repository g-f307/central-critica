          ...
          <div className={`lg:w-1/2 w-full p-8 md:p-12 ${formCardBgClass}`}>
            ...
            {isLoginView ? (
              <div id="login-form">
                ...
                <div className="mt-6">
                    <a href="http://localhost:5000/api/auth/google" className={`${socialButtonBase} ${socialButtonLight} ${socialButtonDark}`}>
                  ...
                  <div>
                    ...
                    <div {...getRootProps()} className={`${dropzoneBaseClass} ${dropzoneLightClass} ${dropzoneDarkClass} ${isDragActive ? dropzoneActiveClass : ''}`}>
                      ...
                      <div className="space-y-1 text-center">
                        ...
                        <p className={`text-xs ${formMutedTextColor} opacity-70`}>PNG, JPG, GIF, WEBP</p>
                      </div>
                    </div>
                  </div>
                  
                  <div>
                    <label htmlFor="register-profile-image-url" className={`block text-sm font-medium mb-1 ${formMutedTextColor}`}>URL da Imagem de Perfil</label>
                    <input id="register-profile-image-url" type="url" value={profileImageUrl} onChange={(e) => setProfileImageUrl(e.target.value)}
                           className={`${inputBaseClasses} ${inputLightClasses} ${inputDarkClasses}`} placeholder="Cole aqui a URL da imagem" />
